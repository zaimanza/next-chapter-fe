                                ...
                                : <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="relative w-full mb-[1rem]">
                                        ...
                                        <input
                                            type="text"
                                            maxLength="100"
                                            className={`${getYourFirstNameError ? "ring ring-red-500 placeholder-red-300 text-red-600" : "focus:ring placeholder-gray-300 text-gray-600"} focus:outline-none border-0 px-[0.8rem] py-[0.8rem] bg-white rounded text-sm shadow w-full ease-linear transition-all duration-150`}
                                            placeholder="Ryan"
                                        ...
                                        />
                                        {getYourFirstNameError && (<p className="text-sm text-red-400 mt-[0.2rem]">{getYourFirstNameError}</p>)}
                                    </div>
                                    <div className="relative w-full mb-[1rem]">
                                        <label
                                            className="block uppercase text-sm font-bold mb-[0.6rem]"
                                        ...
                                        <input
                                            type="text"
                                            maxLength="100"
                                            className={`${getYourPartnerFirstNameError ? "ring ring-red-500 placeholder-red-300 text-red-600" : "focus:ring placeholder-gray-300 text-gray-600"} focus:outline-none border-0 px-[0.8rem] py-[0.8rem] bg-white rounded text-sm shadow w-full ease-linear transition-all duration-150`}
                                            placeholder="Katie"
                                        ...
                                        />
                                        {getYourPartnerFirstNameError && (<p className="text-sm text-red-400 mt-[0.2rem]">{getYourPartnerFirstNameError}</p>)}
                                    </div>
                                    <div className="relative w-full mb-[1rem]">
                                        <label
                                            className="block uppercase text-sm font-bold mb-[0.6rem]"
                                        ...
                                        />
                                        {getWeddingDateError && (<p className="text-sm text-red-400 mt-[0.2rem]">{getWeddingDateError}</p>)}
                                    </div>
                                    ...
                                    <div className="relative w-full mb-[1rem]">
                                        ...
                                        <input
                                            type="text"
                                            maxLength="300"
                                            className={`${getLocationError ? "ring ring-red-500 placeholder-red-300 text-red-600" : "focus:ring placeholder-gray-300 text-gray-600"} focus:outline-none border-0 px-[0.8rem] py-[0.8rem] bg-white rounded text-sm shadow w-full ease-linear transition-all duration-150`}
                                        ...
                                        />
                                        {getLocationError && (<p className="text-sm text-red-400 mt-[0.2rem]">{getLocationError}</p>)}
                                    </div>
